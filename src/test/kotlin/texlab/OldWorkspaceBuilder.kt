...
class OldWorkspaceBuilder {
    companion object {
        private val logger = LoggerFactory.getLogger(::OldWorkspaceBuilder::class.java)
    }
    ...
    fun document(uri: URI, text: String): OldWorkspaceBuilder {
        val file = File(uri)
    ...
    fun document(path: String, text: String): OldWorkspaceBuilder {
